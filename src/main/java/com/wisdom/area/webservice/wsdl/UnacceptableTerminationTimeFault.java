...
public class UnacceptableTerminationTimeFault extends Exception {
    ...
    public UnacceptableTerminationTimeFault(java.lang.String message, UnacceptableTerminationTimeFaultType unacceptableTerminationTimeFault) {
        super(message);
        this.faultInfo = unacceptableTerminationTimeFault;
    }

    public UnacceptableTerminationTimeFault(java.lang.String message, UnacceptableTerminationTimeFaultType unacceptableTerminationTimeFault, Throwable cause) {
        super(message, cause);
        this.faultInfo = unacceptableTerminationTimeFault;
    }
