...
public class NotificationProducerRP {
    ...
    protected List<java.lang.String> topicExpressionDialect;
     ...
     * 
     */
    public List<java.lang.String> getTopicExpressionDialect() {
        if (topicExpressionDialect == null) {
            topicExpressionDialect = new ArrayList<java.lang.String>();
        }
