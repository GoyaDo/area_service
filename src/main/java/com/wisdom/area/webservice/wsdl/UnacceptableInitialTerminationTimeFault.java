...
public class UnacceptableInitialTerminationTimeFault extends Exception {
    ...
    public UnacceptableInitialTerminationTimeFault(java.lang.String message, UnacceptableInitialTerminationTimeFaultType unacceptableInitialTerminationTimeFault) {
        super(message);
        this.faultInfo = unacceptableInitialTerminationTimeFault;
    }

    public UnacceptableInitialTerminationTimeFault(java.lang.String message, UnacceptableInitialTerminationTimeFaultType unacceptableInitialTerminationTimeFault, Throwable cause) {
        super(message, cause);
        this.faultInfo = unacceptableInitialTerminationTimeFault;
    }
