...
public class SubscribeCreationFailedFault extends Exception {
    ...
    public SubscribeCreationFailedFault(java.lang.String message, SubscribeCreationFailedFaultType subscribeCreationFailedFault) {
        super(message);
        this.faultInfo = subscribeCreationFailedFault;
    }

    public SubscribeCreationFailedFault(java.lang.String message, SubscribeCreationFailedFaultType subscribeCreationFailedFault, Throwable cause) {
        super(message, cause);
        this.faultInfo = subscribeCreationFailedFault;
    }
