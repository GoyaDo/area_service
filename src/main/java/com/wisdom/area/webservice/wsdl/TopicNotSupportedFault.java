...
public class TopicNotSupportedFault extends Exception {
    ...
    public TopicNotSupportedFault(java.lang.String message, TopicNotSupportedFaultType topicNotSupportedFault) {
        super(message);
        this.faultInfo = topicNotSupportedFault;
    }

    public TopicNotSupportedFault(java.lang.String message, TopicNotSupportedFaultType topicNotSupportedFault, Throwable cause) {
        super(message, cause);
        this.faultInfo = topicNotSupportedFault;
    }
